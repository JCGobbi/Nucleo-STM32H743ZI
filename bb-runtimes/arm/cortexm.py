...
# Added for stm32h743
    'stm32h743':         {'STM32_Main_Clock_Frequency': '480_000_000',
                          'STM32_HSE_Clock_Frequency': '8_000_000',
...
# End
    ...
    def cortex(self):
        if self.mcu.startswith('stm32f4'):
            ...
            return 'cortex-m7'
# Added for stm32h743
        elif self.mcu.startswith('stm32h7'):
            return 'cortex-m7'
# End
        else:
...
# Added for stm32h743
        if self.mcu.startswith('stm32h7'):
           self.add_gnat_sources(
               'arm/stm32/stm32h743/s-bbpara.ads',

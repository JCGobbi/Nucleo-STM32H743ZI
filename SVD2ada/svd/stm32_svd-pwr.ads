...
package STM32_SVD.PWR is
   ...
   subtype CR1_SVOS_Field is HAL.UInt2;
   subtype CR1_ALS_Field is HAL.UInt2;
   ...
   subtype CSR1_ACTVOS_Field is HAL.UInt2;
   ...
   subtype D3CR_VOS_Field is HAL.UInt2;
   ...
   --  WKUPCR_WKUPC array
   type WKUPCR_WKUPC_Field_Array is array (1 .. 6) of Boolean
   ...
   subtype WKUPEPR_WKUPPUPD_Element is HAL.UInt2;

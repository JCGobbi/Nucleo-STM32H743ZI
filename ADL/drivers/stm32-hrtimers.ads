...
package STM32.HRTimers is
   ...
   --  synchronization is sent (refer to Section 37.3.19 in RM0433 rev 7: DAC
   ...
   --  the high-resolution implementation and listed in table 301 of the RM0433
   --  rev 7 chapter 37.3.4.
   --  Prescaler  CKPSC[2:0] Min      Max
   --  Div_1      5          0x0003   0xFFFD
   --  Div_2      6          0x0003   0xFFFD
   --  Div_4      7          0x0003   0xFFFD
   ...
   --  See RM0433 rev. 7 Chapter 21.3.4 pg. 636 Table 302 Timer operating modes.
   ...
   --  See RM0433 rev 7 Section 37.3.3 pg 1377 Timer clock and prescaler.
   --  It is mandatory to have the same prescaling factors for all timers
   --  sharing resources (for instance master timer and Timer A must have
   --  identical CKPSC[2:0] values if master timer is controlling HRTIM_CHA1 or
   --  HRTIM_CHA2 outputs).
   ...
   --  A DAC synchronization event can be enabled and generated when the master
   --  timer update occurs. These bits are defining on which output the DAC
   --  synchronization is sent (refer to RM0433 rev 7 Section 37.3.19: DAC
   --  triggers for connections details).
   ...
   --  RM0433 rev 7 section 37.3.10 pg 1416 Table 310: Update enable inputs and
   ...
   --  stoped (period elapsed), or re-triggerable - a counter reset is done
   --  whatever the counter state (running or stopped).
   --  See RM0433 rev. 7 Chapter 37.3.4 pg. 1380 Section Counter operating mode.
   ...
   --  and set/reset by another timer. See RM0433 rev 7 Chapter 37.5.37 pg 1503.
   ...
   --  signals). See RM0433 rev 7 Chapter 37.3.4 Section Deadtime pg. 1392.
   --  The deadtime cannot be used simultaneously with the push-pull mode.
   ...
   --  output waveform is established. Table 303 at chapter 37.3.4 in the RM0433
   --  rev 7 summarizes the events from other timing units that can be used to
   ...
   --  indicating non-available events. Table 305 at chapter 37.3.7 in the RM0433
   --  rev 7 summarizes the available sources and features associated with each
   ...
   --  37.3.6 at pg. 1397 in the RM0433 rev 7 for set/reset events priorities
   ...
   --  chapter 37.3.4 Set/reset crossbar in the RM0433 rev 7.
   ...
   --  See chapter 37.3.7 at pg. 1398 in RM0433 rev. 7.
   ...
   --  See chapter 37.3.14 at pg. 1432 in RM0433 rev. 7.
   ...
   --  timers or the fHRTIM clock prescaled by a factor. See UM0433 rev 7
   --  chapter 37.3.13 Burst mode controller at section Burst mode clock.
   ...
   --  selecting several sources simultaneously. See chapter 37.3.18 ADC
   --  triggers in the RM0433 rev 7.
   ...
   --  ready. See RM0433 rev 7 Chapter 37.3.22 pg. 1450 for the sequence of
   --  initialization.
